...
class CustomTheme {
  ...
  static const Color loginGradientStart = Color(0xff3da7de);
  static const Color loginGradientEnd = Color(0xff60dc91);
  static const Color white = Color(0xFFFFFFFF);
  static const Color black = Color(0xFF000000);

  static const Color background = Color(0xFFF3F3F3);
  static const Color appBar = Color(0xFF860A35);
  static const Color buttonPrimary = Color(0xE4FF758A);
  static const Color buttonPrimaryGradient = Color(0xD8F1599A);
  static const Color buttonSecondary = Color(0xFFA3B763);
  static const Color buttonSecondaryGradient = Color(0xDD98B245);
